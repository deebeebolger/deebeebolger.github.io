...
ScalpRej --> Notch([Apply notch filter, 4th order Butterworth: 47Hz - 53Hz] ({{< ref "flowchartpages/filtering/index.md" >}}));
Notch --> HPfilt([Apply high-pass filter, 4th order Butterworth : 0.25Hz.]({{< ref "flowchartpages/filtering/index.md" >}}));
